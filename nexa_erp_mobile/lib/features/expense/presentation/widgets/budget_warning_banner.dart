...
class BudgetWarningBanner extends StatelessWidget {
  ...
  const BudgetWarningBanner({super.key, required this.warnings});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.iconOrange.withOpacity(0.3)),
      ),
      child: Column(
          ...
          return Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    w.message ?? '${w.accountName ?? ''} budget এর সীমা অতিক্রম করবে',
